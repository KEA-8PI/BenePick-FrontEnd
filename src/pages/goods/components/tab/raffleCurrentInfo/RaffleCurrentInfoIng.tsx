...
const RaffleCurrentInfo = forwardRef<HTMLElement, RaffleCurrentInfoProps>(({ legendData, seriesData }) => {
  ...
  return (
    <S.Wrapper style={{ paddingTop: '20px', width: '100%' }}>
      <S.Row>
        ...
        <S.ShadowBox style={{ width: 300, height: 300, marginLeft: '40px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start' }}>
            ...
            <Typography style={{ color: colors.grey02, fontWeight: 'bold', paddingTop: '30px', paddingBottom: '30px' }}>
              TOP 5
            </Typography>
            ...
            <S.Row style={{ paddingTop: '20px' }}>
              ...
              <Typography style={{ fontWeight: 'bold', paddingLeft: '5px' }}>{totalRafflePoint}</Typography>
            </S.Row>
          </div>
        </S.ShadowBox>
      </S.Row>
